        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <!-- <article class="entry"> -->
              ...
              <h2 class="entry-title">
                <a>Nisi magni odit consequatur autem nulla dolorem</a>
              </h2>
              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a><time
            ...
            <!-- <article class="entry"> -->
              ...
              <h2 class="entry-title">
                <a>Possimus soluta ut id suscipit ea ut. In quo quia et soluta libero sit
                  sint.</a>
              </h2>
...
<!-- 
              ...
              <h2 class="entry-title">
                <a>Non rem rerum nam cum quo minus. Dolor distinctio deleniti explicabo eius
                  exercitationem.</a>
              </h2>
