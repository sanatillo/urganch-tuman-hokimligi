...
<head>
    ...
    <style>
        /* 1. Reset default active styles (optional but recommended) */
        .nav-link.active {
          color: inherit; /* Inherit from parent or default text color */
          background-color: inherit; /* Inherit from parent or default background */
          /* Other properties you may want to reset (e.g., font weight) */
        }

        /* 2. Style active links (customize as desired) */
        .nav-link.active,
        .nav-link:hover { /* Include hover state for better UX */
          color: #007bff; /* Bootstrap's primary color */
          background-color: #e7f1fe; /* Lighter shade for visual indication */
          border-bottom: 2px solid #dee2e6; /* Optional border for distinction */
        }
    </style>
</head>
